...
func Deposit(w http.ResponseWriter, r *http.Request){
	...
	query := `INSERT INTO transection (user_id, transactionInfo, balance) VALUES ($1, $2, $3) RETURNING id`
	var id int
	err = tx.QueryRow(query, userID, "Deposit", requestMoney.Amount).Scan(&id)
	if err != nil{
